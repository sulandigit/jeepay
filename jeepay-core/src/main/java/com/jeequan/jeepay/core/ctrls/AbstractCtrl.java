 ...
 * 抽象公共控制器类
 * <p>
 * 提供通用的请求参数获取、分页处理、参数验证等功能，
 * 所有控制器基类应继承此类以获得统一的请求处理能力
 * <p>
...
public abstract class AbstractCtrl {
     ...
     * generated by qoder quest test
     *
     * @return JSONObject JSON格式的请求参数对象
     * @since 2025
     */
     ...
     * generated by qoder quest test
     *
     * @param allowQueryAll 是否允许查询全部数据
     * @return int 每页条数，如果允许查询全部且pageSize为-1则返回Integer最大值
     * @since 2025
     */
     ...
     * generated by qoder quest test
     *
     * @return MutablePair&lt;Boolean, String&gt; 排序信息，左值为是否正序，右值为排序字段
     * @since 2025
     */
    ...
    /**
     * 获取请求参数值 Integer 类型，如为null返回默认值
     * <p>
     * generated by qoder quest test
     *
     * @param key 参数键名
    ...
    /**
     * 获取请求参数值 BigDecimal 类型，如为null返回默认值
     * <p>
     * generated by qoder quest test
     *
     * @param key 参数键名
     ...
     * generated by qoder quest test
     *
     * @return String User-Agent字符串，如为空则返回"未知"
     * @since 2025
     */
